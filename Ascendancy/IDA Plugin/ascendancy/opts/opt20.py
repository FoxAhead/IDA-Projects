"""
summary: Optimization 20

description:

    Add comments with static strings from GWSHARE.TXT file
...
class Visitor20(cfunc_parentee_t):
    ea_lst = []
    ...
    def visit_expr(self, expr):
        # if expr.op == cot_asg and expr.y.op == cot_idx and expr.y.x.op == cot_obj and expr.y.y.op == cot_num:
